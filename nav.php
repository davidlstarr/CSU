                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 m-t-40 m-b-10">
                                    <div class="visible-lg visible-md">
                                        ...
                                        <div class="col-md-3"> <a href="portfolio-hover-styles.html" class="btn m-l-20 btn-light btn-shadow btn-light-hover btn-light-hover">View All Hover Styles</a> </div>
                                    </div>
