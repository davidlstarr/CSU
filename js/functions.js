    ...
    INSPIRO.core = {
        functions: function () {
            ...
            w.length > 0 && w.each(function () {
                ...
                e.each(function () {
                    t(this).height() > i && (i = t(this).outerHeight())
                }), e.height(i)
            })
        ...
        functions: function () {
            ...
            m.length > 0 && (e.is(".device-lg, .device-md") ? t("#mainMenu.menu-onclick nav > ul > li > a, .dropdown-submenu > a, .dropdown-submenu > span").on("click", function (a) {
                return t(this).parent("li").siblings().removeClass("hover-active"), t(this).parent("li").toggleClass("hover-active"), !1
            }) : t("#mainMenu nav > ul > li > a, .dropdown-submenu > a, .dropdown-submenu > span").on("click", function (a) {
                t(this).parent("li").siblings().removeClass("hover-active"), t(this).parent("li").toggleClass("hover-active"), a.preventDefault()
        ...
        functions: function () {
            ...
            return t().owlCarousel ? void(t(".inspiro-slider").length > 0 && t(".inspiro-slider").each(function () {
                ...
                if (i = "false" == i ? !1 : !0, n = "false" == n ? !1 : !0, e.find(".slide").each(function () {
            ...
            e = "false" == e ? !1 : !0, i = "false" == i ? !1 : !0, a.owlCarousel({
                nav: e,
                dots: i,
                navText: P,
                autoplay: n,
        ...
        functions: function () {
            ...
            return t().scrolly ? void(y.length > 0 && y.each(function () {
                var a = t(this), i = a.attr("data-parallax-image");
                a.prepend('<div class="parallax-container" data-velocity="-.090" style="background: url(' + i + ')"></div>'), e.hasClass("device-lg") || e.hasClass("device-md") ? a.find(".parallax-container").scrolly({bgParallax: !0}) : a.find(".parallax-container").addClass("parallax-responsive")
