...
$to = "csu4you@yahoo.com, davestarr9@gmail.com";
...
$subject = 'Request from Cleaning Services Unlimited Website: ' . ( $_POST['widget-contact-form-subject']);
...
/*        $company = isset($company) ? "Company: $company<br><br>" : '';
        ...
        $mail->Body = $name . $email . $phone . $message . '<br><br><br>This email was sent from: ' . $_SERVER['HTTP_REFERER'];
